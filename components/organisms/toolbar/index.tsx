...
export default function Toolbar(props) {
     ...
     * @param {Object} ev
     */
    function handleNewFileClick(ev) {
        setBubbles([]);
    }
    ...
    function handleFileOpened(content) {
        ...
        } else alert('Incompatible or corrupted file!');
    }
     ...
     * @param {Object} ev
     */
    function handlePrintClick(ev) {
        setTheme({ ...theme, isPrinting: true });
    }
    useEffect(() => {
        if (isPrinting) {
    ...
    return (
        <div className={'print'}>
            <div className={styles.ToolbarStyle + (props.className || '')}>
                <ColorSelector
                    onColorChange={setPrimaryColor}
                    color={primary}
                    testid="primary-selector"></ColorSelector>
                <ColorSelector
                    onColorChange={setAccentColor}
                    color={accent}
                    testid="accent-selector"></ColorSelector>
